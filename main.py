...
path = "workplace/Deploying-a-Scalable-ML-Pipeline-with-FastAPI/model/encoder.pkl"
encoder = load_model(path)

path = "workplace/Deploying-a-Scalable-ML-Pipeline-with-FastAPI/model/model.pkl"
